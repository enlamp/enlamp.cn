    <h3><?php _e('Reply', 'p2'); ?> <small id="cancel-comment-reply"><?php echo cancel_comment_reply_link() ?></small></h3>
    <?php
    ...
    <form id="commentform" action="<?php echo get_option( 'siteurl' ); ?>/wp-comments-post.php" method="post">
        ...
        <?php if ( $user_ID ): ?>
            <p><?php printf(__('Logged in as <a href="%1$s">%2$s</a>.', 'p2'), get_option('siteurl') . '/wp-admin/profile.php', $user_identity); ?> <a href="<?php echo wp_logout_url(get_permalink()); ?>" title="<?php echo attribute_escape(__('Log out of this account', 'p2')); ?>"><?php _e('Log out &rarr;', 'p2'); ?></a></p>
